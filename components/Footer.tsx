      ...
      <div className="px-8 md:px-12 lg:px-16 py-16 md:py-20 max-w-7xl mx-auto">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-12 lg:gap-8">
          ...
          <div className="lg:col-span-2">
            ...
            <p className="font-sans text-[14px] leading-[1.85] text-cream/80 max-w-[260px] mb-6">
              {t(f.tagline, lang)}
            </p>

            {/* Contact info */}
            <div className="space-y-2 mb-6">
              <div className="font-mono text-[12px] tracking-[0.08em] text-cream/80">{f.contact.phone}</div>
              <div className="font-mono text-[12px] tracking-[0.08em] text-cream/80">{f.contact.email}</div>
              <div className="font-mono text-[12px] tracking-[0.08em] text-cream/80">{f.contact.web}</div>
            ...
            <div key={category}>
              ...
              <ul className="space-y-3">
                {(links as string[]).map((link) => (
                  <li key={link}>
                    <a href="#" className="font-sans text-[14px] leading-[1.85] text-cream/80 hover:text-cream/70 transition-colors duration-300">
                      {link}
                    </a>
                  </li>
                ))}
