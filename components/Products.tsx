...
export default function Products() {
  ...
  return (
    <section
      id='products'
      className='py-24 md:py-36 px-8 md:px-12 lg:px-16 border-t border-white/[0.06]'>
      <div className='max-w-7xl mx-auto'>
        ...
        <div className='flex flex-col md:flex-row md:items-end justify-between gap-8 mb-16'>
          ...
          <div className='text-right'>
            <p className='font-sans text-[12px] text-cream/40 italic mb-3 max-w-xs'>
              {t(p.subtitle, lang)}
            </p>
            <a
              href='#'
              className='font-mono text-[10px] tracking-[0.18em] uppercase text-cream/40 hover:text-cream flex items-center gap-3 transition-colors duration-300 group justify-end'>
              {t(p.viewAll, lang)}
            ...
            <div
              ...
              <div
                ...
                <div
                  ...
                  <p className='font-sans text-[11px] leading-[1.7] text-cream/60 text-center'>
              ...
              <div className='p-5 border-t border-white/[0.06]'>
                <div className='flex justify-between items-start mb-2'>
                  <div>
                    <h3 className='font-sans font-medium text-[14px] text-cream mb-0.5'>
                      {t(product.name, lang)}
                    </h3>
